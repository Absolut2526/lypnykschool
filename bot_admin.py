...
def get_main_keyboard():
    return {
        "keyboard": [
            [{"text": "➕ Опублікувати новину"}, {"text": "📸 Додати світлини"}],
            [{"text": "📄 Додати документ"}, {"text": "🗑 Видалити новину"}],
...
def handle_update(update):
    ...
    if text in ["/start", "/admin", "/menu"]:
        ...
        welcome_text = (
            ...
            "• 📸 Завантажувати світлини до фотогалереї\n"
    ...
    if text in ["📸 Додати світлини", "/add_photo"]:
        USER_STATES[user_id] = {"step": "QUICK_PHOTO_UPLOAD", "photos": []}
        send_message(chat_id, "📸 Надішліть фотографію або кілька фото (можна з підписом). Вони будуть збережені та додані на сайт:")
        return
